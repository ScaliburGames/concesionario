...
class CocheResourceIT {
    ...
    public static Coche createEntity(EntityManager em) {
        Coche coche = new Coche().matricula(DEFAULT_MATRICULA).color(DEFAULT_COLOR).precio(DEFAULT_PRECIO).vendido(DEFAULT_VENDIDO);
        return coche;
    }
    ...
    public static Coche createUpdatedEntity(EntityManager em) {
        Coche coche = new Coche().matricula(UPDATED_MATRICULA).color(UPDATED_COLOR).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
        return coche;
    }
    ...
    void putNewCoche() throws Exception {
        ...
        updatedCoche.matricula(UPDATED_MATRICULA).color(UPDATED_COLOR).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
    ...
    void fullUpdateCocheWithPatch() throws Exception {
        ...
        partialUpdatedCoche.matricula(UPDATED_MATRICULA).color(UPDATED_COLOR).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
