...
class TaskResourceIT {
    ...
    private static final Long DEFAULT_NUMERO_VENTA = 1L;
    private static final Long UPDATED_NUMERO_VENTA = 2L;
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().salario(DEFAULT_SALARIO).numeroVenta(DEFAULT_NUMERO_VENTA);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().salario(UPDATED_SALARIO).numeroVenta(UPDATED_NUMERO_VENTA);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getSalario()).isEqualTo(DEFAULT_SALARIO);
        assertThat(testTask.getNumeroVenta()).isEqualTo(DEFAULT_NUMERO_VENTA);
    }
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].numeroVenta").value(hasItem(DEFAULT_NUMERO_VENTA.intValue())));
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.numeroVenta").value(DEFAULT_NUMERO_VENTA.intValue()));
    }
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.salario(UPDATED_SALARIO).numeroVenta(UPDATED_NUMERO_VENTA);
        ...
        Task testTask = taskList.get(taskList.size() - 1);
        assertThat(testTask.getSalario()).isEqualTo(UPDATED_SALARIO);
        assertThat(testTask.getNumeroVenta()).isEqualTo(UPDATED_NUMERO_VENTA);
    }
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.numeroVenta(UPDATED_NUMERO_VENTA);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.salario(UPDATED_SALARIO).numeroVenta(UPDATED_NUMERO_VENTA);
