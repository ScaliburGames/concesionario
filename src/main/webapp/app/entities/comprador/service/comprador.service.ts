...
export class CompradorService {
  ...
  protected convertDateFromClient(comprador: IComprador): IComprador {
    return Object.assign({}, comprador, {
      fechaNacimiento: comprador.fechaNacimiento?.isValid() ? comprador.fechaNacimiento.toJSON() : undefined,
      fechaCarnet: comprador.fechaCarnet?.isValid() ? comprador.fechaCarnet.toJSON() : undefined,
    });
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.fechaCarnet = res.body.fechaCarnet ? dayjs(res.body.fechaCarnet) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((comprador: IComprador) => {
        ...
        comprador.fechaCarnet = comprador.fechaCarnet ? dayjs(comprador.fechaCarnet) : undefined;
      });
    }
    return res;
  }
