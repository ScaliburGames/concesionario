...
describe('Comprador Management Component', () => {
  let comp: CompradorComponent;
  let fixture: ComponentFixture<CompradorComponent>;
  let service: CompradorService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'comprador', component: CompradorComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CompradorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.compradors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
