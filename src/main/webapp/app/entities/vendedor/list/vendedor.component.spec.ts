...
describe('Vendedor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'vendedor', component: VendedorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vendedors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
