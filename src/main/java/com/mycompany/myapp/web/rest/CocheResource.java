...
public class CocheResource {
    ...
    public ResponseEntity<CocheDTO> updateCoche(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cocheDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CocheDTO> partialUpdateCoche(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cocheDTO.getId().toString())
        );
    }
